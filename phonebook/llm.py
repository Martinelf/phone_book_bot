...
def heuristic_parse_query(user_input: str) -> dict[str, Any]:
    ...
    if phrase_match and not department_hint:
        department_hint = phrase_match.group(1).strip()

    reserved_terms = set(query_token_variants(first_name)) | set(query_token_variants(last_name)) | set(query_token_variants(patronymic))
...
""".strip()
    ...
    try:
        ...
        parsed["department_hint"] = normalize_text(parsed.get("department_hint"))
